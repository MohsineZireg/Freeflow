...
public class NumberlinkPanel extends JPanel implements MouseListener {
    ...
    private void paintDirections( Graphics g, int[] startPos, ArrayList<Direction> directions ) {
        // Ici :
    ...
    public void mouseClicked( MouseEvent e ) {
    	...
    	else if( controller.clickCell( e.getPoint().y / cellSize, e.getPoint().x / cellSize )) {
